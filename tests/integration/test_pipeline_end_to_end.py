...
def test_pipeline_runs_end_to_end_with_tuned_sklearn_and_tfm_models(tmp_path, monkeypatch):
    ...
    for model_result in result.model_results:
        ...
        assert model_result.final_test_metrics.mimic_test is model_result.metrics_by_test_set["mimic"]
        assert model_result.final_test_metrics.tudd_test is model_result.metrics_by_test_set["tudd"]
