...
class TabDPTAdapter(ModelAdapter):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.random_state = inference_state
        default_kwargs = {"device": "cuda"}
        self.n_ensembles = kwargs.pop("n_ensembles", 8)
    ...
    def _load_model(self):
        if self.task_type == "classification":
            model = TabDPTClassifier(**self.kwargs)
        else:
            model = TabDPTRegressor(**self.kwargs)
        return model
